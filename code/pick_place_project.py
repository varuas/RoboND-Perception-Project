...
def pr2_mover(detected_objects):
    ...
    # TODO Enhancement: Rotate PR2 in place to capture side tables for the collision map
...
if __name__ == '__main__':
    ...
    pcl_test_pub = rospy.Publisher("/test", PointCloud2, queue_size=1)
    ...
    print("Pick-place project node started")
